...
public abstract class MicroService implements Runnable {
     ...
     * /**
     * @PRE name != null
     * @POST The MicroService instance is initialized with the given name.
     */
     ...
     * @POST The MicroService is subscribed to the specified event type.
     */
     ...
     *                 queue.
     * @PRE type != null && callback != null
     * @POST The MicroService is subscribed to the specified broadcast type.
     */
     ...
     * @PRE e != null
     * @POST Returns a Future object if at least one MicroService is subscribed to the event type.
     */
    ...
    * @PRE b != null
     ...
     *               {@code e}.
      * @PRE e != null
     * @POST The event {@code e} is marked as completed with the given result.
     */
     ...
     * this method is called once when the event loop starts.
      * @PRE None
     * @POST The MicroService is initialized and ready to handle messages.
     */
     ...
     * message.
     * @PRE None
     * @POST The MicroService is marked for termination.
     */
     ...
     * @PRE None
     * @POST Returns the name of the MicroService.
     */
     ...
     * * 
     * @PRE None
     * @POST The MicroService processes messages until termination.
     */
    @Override
