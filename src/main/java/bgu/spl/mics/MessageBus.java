...
public interface MessageBus {
     ...
     * @PRE:
     * {@code type} is not null.
     * {@code m} is not null.
     * {@code m} is registered to the message bus.

     * @POST:{@code m} is added to the subscription queue for the given {@code type}.
     */
     ...
     * @PRE:
     * 1. {@code e} is not null.
     * 2. {@code result} is not null.
     * 3. {@code e} was previously sent via {@link #sendEvent}.
     *
     * @POST: The future associated with {@code e} is resolved with {@code result}.
     */
     ...
     *
     * @POST:
     * 1. A future is created and returned for {@code e}.
     * 2. {@code e} is added to the message queue of a subscribed micro-service.
     */
     ...
     * @PRE:
     * 1. {@code m} is not null.
     * 2. {@code m} is not already registered.
     *
     * @POST: A new message queue is allocated for {@code m}.
     */
     ...
     *
     * @POST: {@code m} is removed from the message bus and all related queues.
     */
     ...
     * @PRE:
     * 1. {@code m} is not null.
     * 2. {@code m} is registered to the message bus.
     *
     * @POST:
     * 1. Returns the next message from {@code m}'s queue.
     */
